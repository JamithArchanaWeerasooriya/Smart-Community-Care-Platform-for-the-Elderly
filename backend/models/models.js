...
const EmotionReadingSchema = new mongoose.Schema({
  ...
  flagged:     { type: Boolean, default: false },     // caregiver manually flagged
...
const PatientSchema = new mongoose.Schema({
  ...
  caregivers:  [{ type: String }],   // caregiver emails / ids
  notes:       { type: String, default: '' },
  alertThreshold: { type: Number, default: 3 },  // distress count to trigger alert
}, { timestamps: true });
...
export const EmotionReading = mongoose.model('EmotionReading', EmotionReadingSchema);
export const Session        = mongoose.model('Session',        SessionSchema);
export const Patient        = mongoose.model('Patient',        PatientSchema);
export const Alert          = mongoose.model('Alert',          AlertSchema);
export const CaregiverNote  = mongoose.model('CaregiverNote',  CaregiverNoteSchema);