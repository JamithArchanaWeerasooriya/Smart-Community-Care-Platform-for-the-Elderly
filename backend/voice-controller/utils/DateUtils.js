function exportDate(date) {
    ...
    if (date) {
        ...
        if (dateSplit.length == 1) {
            ...
            if (item1.startsWith("මේ") || item1.startsWith("ලබන") || item1.startsWith("ඊළඟ") || item1.startsWith("ඊලඟ")) {
...
function getDate(value) {
    if (value.startsWith("එකොලොස්") || value.startsWith("එකොළොස්")) {
        return 11;
    } else if (value.startsWith("දොලොස්") || value.startsWith("දොළොස්")) {
        return 12;
    } else if (value.startsWith("දහතුන්")) {
        return 13;
    } else if (value.startsWith("දාහතර")) {
        return 14;
    } else if (value.startsWith("පහලොස්") || value.startsWith("පහළොස්")) {
        return 15;
    } else if (value.startsWith("දාසය")) {
        return 16;
    } else if (value.startsWith("දාහත්")) {
        return 17;
        ...
        return 21;
    } else if (value.startsWith("විසිදෙවෙනි")) {
        return 22;
    } else if (value.startsWith("විසිතුන්")) {
        return 23;
    } else if (value.startsWith("විසිහතර")) {
        return 24;
    } else if (value.startsWith("විසිපස්")) {
        return 25;
    } else if (value.startsWith("විසිහය")) {
        return 26;
    } else if (value.startsWith("විසිහත්")) {
        return 27;
        ...
        return 31;
    } else if (value.startsWith("විසි")) {
        return 20;
    } else if (value.startsWith("තිස්")) {
        return 30;
    } else if (value.startsWith("පල") || value.startsWith("පළ")) {
        return 1;
    } else if (value.startsWith("දෙවෙ") || value.startsWith("දෙවැ")) {
        return 2;
    } else if (value.startsWith("තුන්")) {
        return 3;
    } else if (value.startsWith("හතර")) {
        return 4;
    } else if (value.startsWith("පස්")) {
        return 5;
